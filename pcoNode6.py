...
# node configuration
init_state = [
    {'id': 0, 'initial_time_offset': 0, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'solid',
     'hatch': '///'},
    {'id': 1, 'initial_time_offset': 10, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'dashed',
     'hatch': '--'},
    {'id': 2, 'initial_time_offset': 20, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'dotted',
     'hatch': '.'},
    {'id': 3, 'initial_time_offset': 30, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'dashdot',
     'hatch': 'x'},
    {'id': 4, 'initial_time_offset': 40, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'dashdot',
     'hatch': 'x'},
    {'id': 5, 'initial_time_offset': 101, 'clock_drift_rate': random.randint(-100, 100), 'clock_drift_scale': 0.1, 'linestyle': 'dashdot',
     'hatch': 'x'},
]
...
nodes = [PCONode6(env, state) for state in init_state]
